 ...
 */
class Magasinier extends \HTM\StockBundle\Entity\Magasinier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'id', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'nom', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'prenom', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'cIN', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'adresse', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'telephone', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'datenaissance', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'sexe', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'salePoint', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'user', '' . "\0" . 'HTM\\StockBundle\\Entity\\Magasinier' . "\0" . 'PointDeVente');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Magasinier $proxy) {
    ...
    public function setPointdevente(\HTM\StockBundle\Entity\PointDeVente $pointdevente = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPointdevente', array($pointdevente));

        return parent::setPointdevente($pointdevente);
    }
    ...
    public function getPointdevente()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPointdevente', array());

        return parent::getPointdevente();
    }
    ...
    public function setSalePoint(\HTM\StockBundle\Entity\PointDeVente $salePoint = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSalePoint', array($salePoint));

        return parent::setSalePoint($salePoint);
    }
    ...
    public function getSalePoint()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSalePoint', array());

        return parent::getSalePoint();
    }
