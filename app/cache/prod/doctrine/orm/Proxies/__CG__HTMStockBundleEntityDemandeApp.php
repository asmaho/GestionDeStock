 ...
 */
class DemandeApp extends \HTM\StockBundle\Entity\DemandeApp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'id', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'description', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'dateAjout', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'quantite', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'produit', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'statut', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'pointDeVente', '' . "\0" . 'HTM\\StockBundle\\Entity\\DemandeApp' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DemandeApp $proxy) {
    ...
    public function setGouvernorat($gouvernorat)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setGouvernorat', array($gouvernorat));
    ...
    public function getGouvernorat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGouvernorat', array());
