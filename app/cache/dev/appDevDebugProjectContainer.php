...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.fournisseur' => 'getSecurity_Firewall_Map_Context_FournisseurService',
            'security.firewall.map.context.magasinier' => 'getSecurity_Firewall_Map_Context_MagasinierService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.fournisseur' => 'security.user_checker.main',
            'security.user_checker.magasinier' => 'security.user_checker.main',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'media_web', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\HTM\\StockBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\HTM\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'HTM\\StockBundle\\Entity');
        $c->addDriver($b, 'HTM\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('HTMStockBundle' => 'HTM\\StockBundle\\Entity', 'HTMUserBundle' => 'HTM\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2c2b7cd0fc5cec89ff0fac6a5b3b880399dfec0d3e11d7f306a9272c8b2eecae');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('HTM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('HTM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('HTM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('HTM\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'HTM\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), 'security.firewall.map.context.magasinier' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/magasinier'), 'security.firewall.map.context.fournisseur' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/fournisseur'), 'security.firewall.map.context.default' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'default', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $c, 'default', $d, $b), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5765e6b782b3c8.34214317', $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'default', $d, NULL, NULL, $b, false));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.fournisseur' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_FournisseurService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '99f9fd9ab9cbd330b8023b51f391455797352d0b', 'fournisseur', array('lifetime' => 86400, 'path' => '/fournisseur', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($d, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/fournisseur/logout'));
        $j->addHandler($this->get('security.logout.handler.session'));
        $j->addHandler($i);

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $a, array(), $c);
        $k->setOptions(array('login_path' => '/fournisseur/login', 'failure_path' => '/fournisseur/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $l = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $f, $g, $a, 'fournisseur', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('security.authentication.customized_success_handler'), array('login_path' => '/fournisseur/login', 'default_target_path' => '/fournisseur', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false), 'fournisseur'), $k, array('check_path' => '/fournisseur/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $h, $this->get('form.csrf_provider'));
        $l->setRememberMeServices($i);

        return $this->services['security.firewall.map.context.fournisseur'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $j, 3 => $l, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $i, $f, $c, $h, true, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '5765e6b782b3c8.34214317', $c, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $a, 'fournisseur', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $a, '/fournisseur/login', false), NULL, NULL, $c, false));
    }

    /**
     * Gets the 'security.firewall.map.context.magasinier' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_MagasinierService()
    {
        $a = $this->get('security.http_utils');
        $b = $this->get('fos_user.user_provider.username_email');
        $c = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);
        ...
        $i = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '99f9fd9ab9cbd330b8023b51f391455797352d0b', 'magasinier', array('lifetime' => 86400, 'path' => '/fournisseur', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($d, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/magasinier/logout'));
        $j->addHandler($this->get('security.logout.handler.session'));
        $j->addHandler($i);

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $a, array(), $c);
        $k->setOptions(array('login_path' => '/magasinier/login', 'failure_path' => '/magasinier/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $l = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $f, $g, $a, 'magasinier', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('security.authentication.customized_success_handler'), array('login_path' => '/magasinier/login', 'use_referer' => true, 'default_target_path' => '/magasinier', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path'), 'magasinier'), $k, array('check_path' => '/magasinier/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $h, $this->get('form.csrf_provider'));
        $l->setRememberMeServices($i);

        return $this->services['security.firewall.map.context.magasinier'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $j, 3 => $l, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $i, $f, $c, $h, true, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '5765e6b782b3c8.34214317', $c, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $a, 'magasinier', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $a, '/magasinier/login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '99f9fd9ab9cbd330b8023b51f391455797352d0b', 'main', array('lifetime' => 86400, 'path' => '/admin', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $j = new \Symfony\Component\Security\Http\Firewall\LogoutListener($d, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/admin/login'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/admin/logout'));
        $j->addHandler($this->get('security.logout.handler.session'));
        $j->addHandler($i);

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $a, array(), $c);
        $k->setOptions(array('login_path' => '/admin/login', 'failure_path' => '/admin/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $l = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($d, $f, $g, $a, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('security.authentication.customized_success_handler'), array('login_path' => '/admin/login', 'default_target_path' => '/admin', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false), 'main'), $k, array('check_path' => '/admin/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $c, $h, $this->get('form.csrf_provider'));
        $l->setRememberMeServices($i);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $j, 3 => $l, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($d, $i, $f, $c, $h, true, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($d, '5765e6b782b3c8.34214317', $c, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($d, $this->get('security.authentication.trust_resolver'), $a, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $a, '/admin/login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\HTM\\StockBundle/Resources/views'), 'HTMStock');
        $instance->addPath(($this->targetDirs[3].'\\src\\HTM\\UserBundle/Resources/views'), 'HTMUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/views'), 'KnpPaginator');
        $instance->addPath(($this->targetDirs[3].'\\src\\HTM\\MagasinierBundle/Resources/views'), 'HTMMagasinier');
        $instance->addPath(($this->targetDirs[3].'\\src\\HTM\\FournisseurBundle/Resources/views'), 'HTMFournisseur');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('99f9fd9ab9cbd330b8023b51f391455797352d0b');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/fournisseur/login$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/fournisseur/login_check$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/magasinier/login$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/magasinier/login_check$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/register$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/resseting$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin'), array(0 => 'ROLE_SUPER_ADMIN', 1 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/magasinier'), array(0 => 'ROLE_MAGASINIER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/fournisseur'), array(0 => 'ROLE_FOURNISSEUR'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/change-password'), array(0 => 'ROLE_USER'), NULL);
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \HTM\UserBundle\Handler\Authentication\AuthenticationSuccessHandler A HTM\UserBundle\Handler\Authentication\AuthenticationSuccessHandler instance.
     */
    protected function getSecurity_Authentication_CustomizedSuccessHandlerService()
    {
        return $this->services['security.authentication.customized_success_handler'] = new \HTM\UserBundle\Handler\Authentication\AuthenticationSuccessHandler($this->get('security.http_utils'), array(), $this->get('router'), $this->get('security.context'), $this->get('doctrine.orm.default_entity_manager'), $this->get('session'));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($b, '99f9fd9ab9cbd330b8023b51f391455797352d0b', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5765e6b782b3c8.34214317'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'magasinier', $c, true), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($b, '99f9fd9ab9cbd330b8023b51f391455797352d0b', 'magasinier'), 5 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5765e6b782b3c8.34214317'), 6 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'fournisseur', $c, true), 7 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($b, '99f9fd9ab9cbd330b8023b51f391455797352d0b', 'fournisseur'), 8 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5765e6b782b3c8.34214317'), 9 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'default', $c, true), 10 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5765e6b782b3c8.34214317')), true);
    ...
    {
        return $this->services['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener($this->get('security.token_storage'), array(0 => $this->get('fos_user.user_provider.username_email')), 'stock', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('magasinier', '/magasinier/logout', 'logout', '_csrf_token', NULL);
        $instance->registerListener('fournisseur', '/fournisseur/logout', 'logout', '_csrf_token', NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPERADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_MAGASINIER' => array(0 => 'ROLE_USER'), 'ROLE_FOURNISSEUR' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HTMStockBundle' => 'HTM\\StockBundle\\HTMStockBundle',
                'HTMUserBundle' => 'HTM\\UserBundle\\HTMUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'HTMMagasinierBundle' => 'HTM\\MagasinierBundle\\HTMMagasinierBundle',
                'HTMFournisseurBundle' => 'HTM\\FournisseurBundle\\HTMFournisseurBundle',
            ...
            'secret' => '99f9fd9ab9cbd330b8023b51f391455797352d0b',
            'locale' => 'fr',
            ...
            'kernel.secret' => '99f9fd9ab9cbd330b8023b51f391455797352d0b',
            ...
            'fos_user.model.user.class' => 'HTM\\UserBundle\\Entity\\User',
